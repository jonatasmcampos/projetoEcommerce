    ...
    <form action="{{ route('usuariohome') }}" method="GET">
        ...
        <main class="conteudoPrincipal" style="padding: 0 25px">
                                ...
                                @foreach ($categorias as $cat)
                                    <li class="form-check">
                                        <input class="form-check-input" name="cat" type="checkbox"
                                            ...
                                            {{ in_array($cat->id, $boxes['cat']) ? 'checked' : '' }}>
                                ...
                                @foreach ($cores as $cor)
                                    <li class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $cor->id }}"
                                            name="cor[]" id="flexCheckDefault"
                                            {{ in_array($cor->id, $boxes['cor']) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ $cor->nome }}
                                        </label>
                                    </li>
                                ...
                                @foreach ($tamanhos as $t)
                                    <li class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $t->id }}"
                                            name="tam[]" id="flexCheckDefault"
                                            {{ in_array($t->id, $boxes['tam']) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            {{ $t->nome }}
                                        </label>
                                    </li>
            ...
            <section class="conteudoFiltrado">
                ...
                <button type="button" class="btn btn-primary btn-filtrar" data-bs-toggle="modal"
