...
@else
    <div id="etapa3Produto" style="visibility: hidden;">
        @if ($produto && count($produto->imagens))
            ...
            <div class="collapse" id="collapseExample">
                ...
                <form enctype="multipart/form-data" action="{{ route('produto.update', $produto->id) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                ...
                <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Adicionar</button> --}}
                    ...
                    <div class="file btn btn-primary btn-add-imagem">
                        ...
                        <input class="input-upload-imagem" id="imagesProdutoName" type='file' name='image[]'
                            accept="image/*" multiple id='file-input' onchange="newInput(this)" />
                    </div>
